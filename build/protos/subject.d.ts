...
export declare const SubjectAbsentCredentials: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SubjectAbsentCredentials;
...
export declare const SubjectCredentialsAbsentDto: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SubjectCredentialsAbsentDto;
...
export declare const SubjectCredentialIssuerInfoDto: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SubjectCredentialIssuerInfoDto;
