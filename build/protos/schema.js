...
exports.SchemaAttributesDto = exports.SchemaPresentationDto = exports.SchemaGroupings = exports.CredentialSchemaData = exports.PresentationSchema = exports.PresentationSchemaAttributes = exports.SchemaPresentationRequestDto = exports.SchemaAttributesRequestsDto = exports.protobufPackage = void 0;
/* eslint-disable */
...
var baseSchemaAttributesDto = {};
exports.SchemaAttributesDto = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        for (var _i = 0, _a = message.credentials; _i < _a.length; _i++) {
            var v = _a[_i];
            exports.PresentationSchema.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = __assign({}, baseSchemaAttributesDto);
        message.credentials = [];
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
